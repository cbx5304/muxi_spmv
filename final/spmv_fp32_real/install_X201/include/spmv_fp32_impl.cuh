...
// - avgNnz < 32: TPR=8 (8 rows/warp) - sparse (optimal for avgNnz~10)
// - avgNnz < 64: TPR=16 (4 rows/warp) - moderately dense
// - avgNnz < 128: TPR=32 (2 rows/warp) - dense (optimal for avgNnz~85)
    ...
    cudaStream_t stream = 0)
{
    ...
    if (avgNnz >= 128) {
        ...
        TPR = 16;  // Moderately dense: 4 rows/warp, ~80% utilization
    } else if (avgNnz >= 16) {
